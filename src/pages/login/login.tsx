...
import { Layout, Space, Form, Input, Checkbox, Button, Flex } from "antd";
        ...
        <Card
          ...
          <Form initialValues={{Remember : true}}>
            <Form.Item name="username" rules={[
              {required: true,
              message: "please Input Enter Username"
              },
              {
                type: "email",
              ...
              <Input prefix={<UserOutlined/>} placeholder="Username"></Input></Form.Item>
            <Form.Item name="password" rules={[{
              required: true,
              message: "please Input Enter Password"
            }]}>
            <Input.Password prefix={<LockOutlined/>} placeholder="Password" /></Form.Item>
